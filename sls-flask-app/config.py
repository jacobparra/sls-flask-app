...
# use local "sls-flask-app" DB for local dev
DEFAULT_DB_URL = "postgresql:///sls-flask-app"
...
class Config:
    ...
    APP_SECRETS_NAME = os.getenv("APP_SECRETS_NAME", "sls-flask-app/dev")
...
class ProductionConfig(Config):
    ...
    APP_SECRETS_NAME = "sls-flask-app/prd"
...
def check_valid_handler(event, context):
    ...
    config_class = event.get("env", "sls-flask-app.config.LocalDevConfig")
