...
from sls-flask-app.api import init_views
from sls-flask-app.create_app import create_app
from flask_jwt_extended import create_access_token
from sls-flask-app.db.fixtures import NormalUserFactory
...
DB_CONN = os.getenv("SQLALCHEMY_DATABASE_URI", "postgresql:///sls-flask-app_test".lower())
...
def _db(app):
    ...
    from sls-flask-app.db import db
